...
user3 = User.create! :name => 'Admin User', :email => 'admin@example.com', :password => 'please', :password_confirmation => 'please', :confirmed_at => Time.now.utc, :is_admin => true
puts 'Admin user created: ' << user3.name
